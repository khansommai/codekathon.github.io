...
try:
    ...
    while True:
        ...
        if GPIO.input(23):
            ...
            #หน่วงเวลา 5 วินาที เพื่อหลีกเลี่ยงการตรวจจับหลายครั้ง
            time.sleep(5)
        #หน่วงเวลาการวนลูป 0.1 วินาที ซึ่งควรตั้งค่าน้อยกว่าเวลาหน่วงของการตรวจจับการเคลือนไหว
        time.sleep(0.1)
except:
    GPIO.cleanup()
