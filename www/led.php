...
<?php
  if(isset($_GET['ron']))
  {
    $rest =	shell_exec("/usr/bin/sudo raspi-gpio set 20 op pn dh");
  }
  else if(isset($_GET['roff']))
  {
	$rest =	shell_exec("/usr/bin/sudo raspi-gpio set 20 op pn dl");
  }
  else if(isset($_GET['yon']))
  {
    $rest =	shell_exec("/usr/bin/sudo raspi-gpio set 21 op pn dh");
  }
  else if(isset($_GET['yoff']))
  {
	$rest = shell_exec("/usr/bin/sudo raspi-gpio set 21 op pn dl");
  }
?>
   </body>
</html>